print Cumfort very bigg gey <3
#!/usr/bin/python
 
import socket, random, sys, time, os, platform, base64

""" Nonfunctioning's Cannon """
"""
...
if len(sys.argv) != 5:
        print("\nUsage: %s <Skids IP> <PORT (If you don't know use 80)> <Packet Size (MAX 65500)> <Duration Time (0 = forever)>\n" % sys.argv[0])
        sys.exit(1)
...
print("[Starting UDP Flood on %s with %s bytes for %s seconds - Made by Hcui]" % (qIP, qPSize, qDuration or 'Infinite'))
